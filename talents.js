...
var talents = [
    ...
    },
    {
      ...
      keybind: '"[[F]]"',
      description: "See low-health players through walls. Cast to fly to a low-health target. Landing knocks nearby enemies back and applies a short stun.",
      cooldown: 0,
      ...
      tuning: [
        ...
        { macro: "GRIM_REAPER_HEALTH_THRESHOLD", expr: "0.35" },
    ...
    },
    {
      ...
      keybind: '"[[RIGHTCLICK]]"',
      description: "Secondary Fire: Launch a slow-moving fireball that explodes in a large area, burning enemies over time. Deals full damage within 1.5m of the impact, fading to a third at the edge.",
      cooldown: 12,
      upgrade_information: "[Upgrade: +Damage]",
      cd_reduction_per_rank: 0,
      requires_any_of: [],
      ...
      locks: ["helix", "railgun"],
      stats: [
        { label: "Instant Damage", base: 62.5, perRank: 15.625 },
        { label: "Damage Over Time", base: 62.5, perRank: 15.625 },
        { label: "DoT Duration", base: 5, perRank: 0, suffix: "s" },
        { label: "Self-Damage", base: 33.333, perRank: 0, suffix: "%", decimals: 1 },
        { label: "Cooldown", base: 12, perRank: 0, suffix: "s" },
      ],
      tuning: [
        { macro: "FIREBALL_DAMAGE", expr: "46.875 + {r} * 15.625" },
        { macro: "FIREBALL_DAMAGE_SELF", expr: "(46.875 + {r} * 15.625) / 3" },
    ...
    },
    {
      ...
      locks: [],
      stats: [
        { label: "Instant Healing", base: 125/3, perRank: 125/12 },
        { label: "Healing Over Time", base: 125/3, perRank: 125/12 },
        { label: "HoT Duration", base: 5, perRank: 0, suffix: "s" },
      ],
      tuning: [
        { macro: "PYROMANIAC_INSTANT_HEALING", expr: "min((46.875 + {r} * 15.625) * 2 / 3 * eventPlayer.pyromaniac_heal_fraction, eventPlayer.getMaxHealthOfType(Health.NORMAL) - eventPlayer.getHealthOfType(Health.NORMAL))" },
        { macro: "PYROMANIAC_HEALING_OVER_TIME", expr: "(9.375 + {r} * 3.125) * 2 / 3 * eventPlayer.pyromaniac_heal_fraction" },
