var talents = [
    ...
    { 
      ...
      comment: "Slow duration will scale with your cooldown of Helix Rockets.",
      cooldown: 0,
    ...
    { 
      ...
      comment: "The healing will scale with your cooldown of Helix Rockets and your rate of fire of your Primary Fire",
      cooldown: 0,
      upgrade_information: "[Upgrade: +Healing]",
      cd_reduction_per_rank: 0,
      requires_any_of: [],
    ...
    { 
      ...
      comment: "The damage will scale with your cooldown of Helix Rockets",
      cooldown: 0,
      upgrade_information: "[Upgrade: +Damage]",
      cd_reduction_per_rank: 0,
      requires_any_of: [],
    ...
    { 
      ...
      keybind: '"[Passive]"',
      description: "Deal damage to nearby, visible players when not sprinting. Enemies take damage from your XP orb if picked up before 4 seconds",
      comment: "",
      cooldown: 0,
      upgrade_information: "[Upgrade: +Damage]",
      cd_reduction_per_rank: 0,
    ...
    { 
      ...
      keybind: '"[Passive]"',
      description: "Disable your primary fire and reduce the cooldown of your Helix Rockets from 6 seconds down to 0.85 seconds.",
      comment: "",
      cooldown: 0,
    ...
    { 
      ...
      keybind: '"[Passive]"',
      description: "Massively increase your health, but slightly reduce your speed and increase your size.",
      comment: "",
      cooldown: 0,
      upgrade_information: "[Upgrade: +Health, -Speed, +Size]",
      cd_reduction_per_rank: 0,
      requires_any_of: [],
      is_unique: true,
    ...
    { 
      id: "gunslinger",
      name: "Gunslinger",
      icon: "abilityIconString(Hero.MCCREE, Button.ULTIMATE)",
      keybind: '"[LEFTCLICK]"',
