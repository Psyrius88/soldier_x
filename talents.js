var talents = [
    ...
    { 
      ...
      keybind: '"[Passive]"',
      description: "Increase your health and resistance to knockbacks, but slightly reduce your speed and increase your size.",
      comment: "",
      cooldown: 0,
      upgrade_information: "[Upgrade: +Health, +Knockback Resist, -Speed, +Size]",
      cd_reduction_per_rank: 0,
      requires_any_of: [],
      is_unique: true,
      conflicts_with: ["sprinter"],
