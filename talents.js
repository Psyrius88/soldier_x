var talents = [
    ...
    { 
      ...
      comment: "Hitting 1 enemy will reduce the cooldown by half. Hitting at least 2 enemies will reduce the cooldown to 1 sec.",
      requires_any_of: [],
      is_unique: true,
    ...
    { 
      ...
      keybind: '"[Press: [F]]"',
      description: "Activate to start charging. Hitting a player will stun them and pick them up. Hitting a wall will damage players around you.",
    ...
    { 
      ...
      keybind: '"[Press: [E]]"',
      description: "Buy 3 Health Potions. Each potion vial refills one at a time after 15 seconds.",
      comment: "The healing of the potions stack.",
      requires_any_of: [],
      is_unique: true,
    ...
    { 
      ...
      keybind: '"[Passive]"',
      description: "Resist a lot of damage while you are reloading, sprinting or is stunned. Also works during Juggernaut.",
      comment: null,
      requires_any_of: [],
      is_unique: true,
  ...
  var result = ""
  result += "globalvar unique_talents = ["+talents.map(x => x.is_unique)+"]\n"
