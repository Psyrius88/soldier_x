var talents = [
    ...
    { 
      ...
      keybind: '"[PASSIVE]"',
      description: "Low health targets will light up and you can see them through walls.",
      comment: "",
      cooldown: 0,
    ...
    { 
      ...
      keybind: '"[Passive]"',
      description: "Increase your health, but slightly reduce your speed and increase your size.",
      comment: "",
      cooldown: 0,
